...
function dogVote(int) {
  ...
  xmlhttp.open("GET","dog1.php?vote="+int,true);
  xmlhttp.send();
}
</script>
...
<img src="https://hips.hearstapps.com/ghk.h-cdn.co/assets/16/08/gettyimages-464163411.jpg?crop=1.0xw:1xh;center,top&resize=980:*" width="500" height="600">
